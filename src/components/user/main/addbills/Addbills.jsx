  ...
  return (
    <div className='bg-[#efefef] size-full flex justify-center items-center'>
      ...
      <div className='border-2  w-full flex justify-center items-center px-3 rounded-sm'>
            ...
            <div className='border-2  w-full flex justify-center items-center px-3 rounded-sm'>
              <input type="text" name="PoNo" placeholder='Enter PoNo' className='w-full outline-none px-4 h-10' onChange={handleChange}/>
            ...
            <div className='border-2  w-full flex justify-center items-center px-3 rounded-sm'>
              <input type="text" name="address" placeholder='Enter Address' className='w-full outline-none px-4 h-10' onChange={handleChange}/>
